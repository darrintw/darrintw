    ...
    a.fn.scrollTo = function (b) {
        ...
        this.each(function () {
            ...
            function e(b) {
                ...
                var c, e = window.innerHeight, f = g.innerHeight(), k = g.offset().left,
                    l = g.offset().top - a(window).scrollTop(), m = h.alignment, n = 0;
                h.belowOrigin === !0 && (n = f);
                var o = 0, p = g.parent();
                if (!p.is("body") && p[0].scrollHeight > p[0].clientHeight && (o = p[0].scrollTop), k + j.innerWidth() > a(window).width() ? m = "right" : k - j.innerWidth() + g.innerWidth() < 0 && (m = "left"), l + j.innerHeight() > e) if (l + f - j.innerHeight() < 0) {
                    var q = e - l - n;
                    j.css("max-height", q)
    ...
    e.fn.extend({
        openModal: function (t) {
            ...
            return "block" == n.css("display") ? (associatedOverlayID = n.data("overlay-id"), $associatedOverlay = e("#" + associatedOverlayID), $associatedOverlay.css("z-index", 1e3 + 2 * c), void n.css("z-index", 1e3 + 2 * c + 1)) : (overlayID = a(), $overlay = e('<div class="lean-overlay"></div>'), $overlay.attr("id", overlayID).css("z-index", 1e3 + 2 * c), n.data("overlay-id", overlayID).css("z-index", 1e3 + 2 * c + 1), e("body").append($overlay), t = e.extend(i, t), t.dismissible && ($overlay.click(function () {
                ...
                n.closeModal(t)
            }), $overlay.css({display: "block", opacity: 0}), n.css({
                display: "block",
                opacity: 0
            }), $overlay.velocity({opacity: t.opacity}, {
                ...
                duration: t.in_duration, queue: !1, ease: "easeOutCubic", complete: function () {
                    "function" == typeof t.ready && t.ready()
                }
            }) : (e.Velocity.hook(n, "scaleX", .7), n.css({top: t.starting_top}), n.velocity({
                top: "10%",
                opacity: 1,
                scaleX: "1"
            }, {
        ...
        closeModal: function (t) {
            var a = {out_duration: 250, complete: void 0}, i = e(this), n = i.data("overlay-id"), c = e("#" + n);
            t = e.extend(a, t), e("body").css("overflow", ""), i.find(".modal-close").off("click.close"), e(document).off("keyup.leanModal" + n), c.velocity({opacity: 0}, {
                duration: t.out_duration,
                queue: !1,
                ease: "easeOutQuart"
            }), i.hasClass("bottom-sheet") ? i.velocity({bottom: "-100%", opacity: 0}, {
                duration: t.out_duration,
                queue: !1,
                ease: "easeOutCubic",
                complete: function () {
                    c.css({display: "none"}), "function" == typeof t.complete && t.complete(), c.remove(), o--
                }
            }) : i.velocity({top: t.starting_top, opacity: 0, scaleX: .7}, {
                duration: t.out_duration,
                complete: function () {
        ...
        leanModal: function (o) {
            return this.each(function () {
                var t = {starting_top: "4%"}, a = e.extend(t, o);
